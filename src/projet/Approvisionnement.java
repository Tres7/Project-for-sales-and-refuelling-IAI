...
public class Approvisionnement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Entrer le libellé:");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(lib, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(39, 39, 39)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
        String nom=(String)lib.getText();
        int chiffre=(int)(Integer.parseInt(quan.getText()));
        new Enregistrer().approvisionner(nom, chiffre);
        JOptionPane mess= new JOptionPane();
        mess.showMessageDialog(null,"Approvisionnement réussi","CONNEXION",JOptionPane.INFORMATION_MESSAGE);
        this.dispose();
